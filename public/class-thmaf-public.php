...
//print_r($shipping_addresses);
         ...
         //   $custom_addresses = get_user_meta($customer_id, THMAF_Utils::ADDRESS_KEY, true);    
            ...
            //$count = $custom_addresses_shipping + 1;
           // echo count($custom_addresses_shipping);
           // $count = is_array($custom_addresses_shipping) ? count($custom_addresses_shipping) + 1 : 0 ;
            print_r($count);
            ?> 
                ...
                if (! wc_ship_to_billing_address_only() && wc_shipping_enabled()) {
                    ...
                    <?php } ?>
                        ...
                        <div class="add-address thmaf-add-adr btn-add-address-div">
                         <a href="<?php echo esc_url(wc_get_endpoint_url('edit-address') .'shipping/atype='.$count); ?>">Add Address</a>
                       </div>
